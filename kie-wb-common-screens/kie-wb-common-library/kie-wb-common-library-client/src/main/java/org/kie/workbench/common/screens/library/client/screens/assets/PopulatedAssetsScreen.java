...
public class PopulatedAssetsScreen {
    ...
    @PostConstruct
    public void init() {
        this.workspaceProject = libraryPlaces.getActiveProject();
        this.view.init(this);
        this.filterType = "ALL";
    ...
    protected ProjectAssetsQuery createProjectQuery(String filter,
        ...
        return new ProjectAssetsQuery(libraryPlaces.getActiveProject(),
                                      filter,
                                      startIndex,
                                      amount,
                                      suffixes);
    ...
    private boolean isProjectNull() {
        return this.libraryPlaces.getActiveProject() == null || this.libraryPlaces.getActiveProject().getMainModule() == null;
    }
}
